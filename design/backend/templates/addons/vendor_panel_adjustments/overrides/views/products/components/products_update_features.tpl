<div class="products__features {if $selected_section !== "features"}hidden{/if} {if $hide_inputs}cm-hide-inputs{/if}" id="content_features">
    ...
    <div id="products_update_features_content">
        ...
        {else}
            <p class="no-items">{__("no_items_changed")}</p>
        {/if}
